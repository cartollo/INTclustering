...
ifelse(test, yes, no) # è un if else vettoriale, se test è vero restituisce yes, altrimenti no, e lo fa per ogni elemento del vettore test, quindi restituisce un vettore di yes e no
